...
function Convo({ person, send, setSend, setShow, setMessage }) {
  ...
  return (
    <div style = {{height: "82%", position: 'relative'}}>
      <div ref={scrollRef} className = 'd-flex flex-column overflow-auto pb-2 bg-white h-100' >
        ...
        <BsChevronDoubleDown  className='bg-secondary text-white p-1 btn fs-5' onClick={scrollDown}
        style={{position: 'absolute', bottom: '1rem', right:'1rem', cursor: 'pointer', borderRadius: '50%'}} />
